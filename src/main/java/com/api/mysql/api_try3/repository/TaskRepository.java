...
public interface TaskRepository extends JpaRepository<Task, Integer> {
    ...
    List<Task> findTaskByCriteria(@Param("idRoom") int idRoom, @Param("date") String date, @Param("time") String time, @Param("name") String name, @Param("points") String points, @Param("checkBoxes") String checkBoxes);

    List<Task> findByIdRoom(int idRoom);
}
