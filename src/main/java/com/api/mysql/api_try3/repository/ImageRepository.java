...
public interface ImageRepository extends JpaRepository<Image, Long> {
    ...
    Image findImageByCriteria(@Param("idRoom") Long idRoom, @Param("date") String date, @Param("time") String time, @Param("imageData") byte[] imageData, @Param("imageType") String imageType);
