...
public interface EventRepository extends JpaRepository<Event, Integer> {
    ...
    Event findEventByCriteria(@Param("idRoom") int idRoom, @Param("date") String date, @Param("time") String time, @Param("place") String place, @Param("event") String event);

    List<Event> findByIdRoom(int idRoom);
}
